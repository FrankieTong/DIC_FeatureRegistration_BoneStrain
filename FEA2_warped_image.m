...
fid=fopen('6-300.am-OrthoSlice.raw');
fixed_image = fread(fid, DimensionSize, 'float32=>float32').';

fid=fopen('FEA2_warped_original.raw');
...
fixed_image_name = '6-300.am-OrthoSlice.tif';
moving_image_name = 'FEA2_warped_original.tif';
...
fid = fopen('FEA2_disp_original.raw');
...
fid = fopen('FEA2_strain_original.raw');
