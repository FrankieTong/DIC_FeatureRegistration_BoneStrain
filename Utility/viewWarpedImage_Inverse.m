...
warpedStack=warpImageStack(reshape(orig_gridX+TOTAL_DEFORMATIONS(:,:,1),nodesPerFrame,1),reshape(orig_gridY+TOTAL_DEFORMATIONS(:,:,2),nodesPerFrame,1),reshape(orig_gridX,nodesPerFrame,1),reshape(orig_gridY,nodesPerFrame,1),def_image256);
...
figure('Name','warpedImage_Inverse');
