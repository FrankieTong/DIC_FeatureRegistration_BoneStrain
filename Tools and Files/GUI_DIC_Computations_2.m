...
for counter = 1:total_num_subsets
    ...
    X_coord_up         = -floor(subset_size/2)+Xp+floor(q_k(1))-interp_buffer:floor(subset_size/2)+Xp+floor(q_k(1))+interp_buffer;
    Y_coord_up         = -floor(subset_size/2)+Yp+floor(q_k(2))-interp_buffer:floor(subset_size/2)+Yp+floor(q_k(2))+interp_buffer;
    X_coord_down       = -floor(subset_size/2)+Xp+floor(q_k(1) + q_k(3))-interp_buffer:floor(subset_size/2)+Xp+floor(q_k(1) + q_k(3))+interp_buffer;
