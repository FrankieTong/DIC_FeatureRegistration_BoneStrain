...
The following function will determine where the best initial guesses are 
for subset splitting. The Bad_Values matrix is needed herebased on the results of correlation.
%}

function q = Initial_Guess_Good_tmp(good_corr, ii, jj, DEFORMATION_PARAMETERS)
