...
rootVideoDir = 'G:\OutsideDropbox\Whitening_Demin\HBondStiffness\Extracted_Video_Data';
...
analysisIndex = 1+analysisIndex;
videoFolder{analysisIndex} = [sampleDir '\Sample3_MH_2466_s321_HBonding_2466_s432\MH_2466_s321_HBonding_2466_s432_Asc0Eh_22pFormic']; 
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2466_s321_H_Bonding_Asc0pEth_22pFormic_abs.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2466_s321_H_Bonding_Desc0pEth_22pFormic_abs.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2466_s432_H_Bonding_Desc0pEth_22pFormic_abs.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2466_MD_s432_H_Bonding_0-Eth_trial4_probablyDidntWork.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2490_MD_s322_H_Bonding__0pEth_trial1_abs.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2526_s713_H_Bonding_Desc0pEth_abs_OnlyAscent.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2490_MD_s322_H_Bonding_22pformic_trial1_abs.xlsx'];
...
mtsDataFile{analysisIndex} = [sampleDir '\MH_MS_2526_MD_s713_H_Bonding_40-Eth_trial1_abs.xlsx'];
