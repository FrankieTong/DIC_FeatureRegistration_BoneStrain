...
fid=fopen('B2R2_0Turns_Centred_Aligned_Float2.am-OrthoSlice.raw');
fixed_image = fread(fid, DimensionSize, 'float32=>float32').';

fid=fopen('B2R2_0Turns2_ReRecon_Realligned2.am-OrthoSlice.raw');
...
fixed_image_name = 'B2R2_0Turns_Centred_Aligned_Float2.am-OrthoSlice.tif';
moving_image_name = 'B2R2_0Turns2_ReRecon_Realligned2.am-OrthoSlice.tif';
