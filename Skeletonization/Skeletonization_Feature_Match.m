function [matched_fixed_points, matched_moving_points, matchedPoints_matchMetric] = Skeletonization_Feature_Match(varargin)
...
for i = 1:size(matchedPoints1,1)
    ...
    matchedPoints_matchMetric = matchMetric(i);
end
