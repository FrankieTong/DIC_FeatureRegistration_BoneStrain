...
fid=fopen('5-300.am-OrthoSlice2.raw');
fixed_image = fread(fid, DimensionSize, 'float32=>float32').';

fid=fopen('6-300.Resampled.am-OrthoSlice2.raw');
...
fixed_image_name = '5-300.am-OrthoSlice2.tif';
moving_image_name = '6-300.Resampled.am-OrthoSlice2.tif';
